...
config :api_service, ApiServiceWeb.Endpoint,
  ...
  live_view: [signing_salt: "J0FvaDzh"]
...
config :api_service, ApiService.Mailer, adapter: Swoosh.Adapters.Local
...
#   {:my_client,
#    [
#      {:endpoints, [localhost: 60230, localhost: 60236, localhost: 60235]},
